...
object Constant {
    ...
    val MIME_TYPE_DOC_DOC = "application/vnd.openxmlformats-officedocument.wordprocessingml.document"
    val MIME_TYPE_PPT_PPT = "application/vnd.ms-powerpoint"
    val MIME_TYPE_PPT_PPTX = "application/vnd.openxmlformats-officedocument.presentationml.presentation"
    val MIME_TYPE_XLS = "application/vnd.ms-excel"
    val MIME_TYPE_XL = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
